...
<head>
  ...
  <title>SPK - SD NEGERI 124395 PEMATANG - SIANTAR</title>
  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        ?>
          <ul class="sidebar-menu" id="nav-accordion">
            <p class="centered"><a href="index.php?module=home"><img src="img/org-icon.png" class="img-circle" width="80"></a></p>
        ...
        <div class="row">
          <div class="col-lg-12 main-chart" style="padding-left: 50px;padding-right: 50px;">
            ...
            <div class="border-head">
              <h3>PENERIMAAN KIP SD NEGERI 124395 PEMATANG - SIANTAR</h3>
            </div>
            <?php
            ...
            } elseif ($_GET['module'] == 'aksi_tambah') {
              include "pages/siswa/aksi_tambah.php";
    ...
    <footer class="site-footer" style="margin-top: 40vh;">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>SD NEGERI 124395 PEMATANG - SIANTAR</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Making by Alfina Nur A & Firdha Arga P</a>
        </div>
